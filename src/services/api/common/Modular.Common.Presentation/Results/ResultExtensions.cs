...
/// <summary>
///     Defines extension methods for use with <see cref="Result" /> and <see cref="Result{TValue}" />.
/// </summary>
public static class ResultExtensions
{
    ...
    ///     Matches a
    ///     <see cref="Result" />
    ///     to either a success or a failure case and executes the corresponding function.
    /// </summary>
